...
const globalStyles = StyleSheet.create({
  ...
  // minHeight: '100%', // Remove this if it's causing layout issues
  },
  practiceContent: {
  ...
  taglinePractice: {
    ...
    fontFamily: 'Nunito-regular', // Use a specific font family for consistency
  ...
  startButton: {
    ...
    paddingHorizontal: 40,
    borderRadius: 8,
    marginVertical: 30, // Add spacing between buttons
  ...
  title: {
    ...
    textShadowRadius: 2,
    marginBottom: 20,
    fontFamily: 'Nunito-Bold', // Use a specific font family for consistency
  },
  headerIcon: {
    width: 80,
    height: 80,
  ...
  backButton: {
    ...
    paddingHorizontal: 30,
    borderRadius: 8,
    marginTop: 5, // Add spacing above the button
    width: '80%', // Wider button
    alignItems: 'center',
  },
  smallBackButton: {
